...
while True:
    ...
    lower_white = np.array([200, 0, 100],np.uint8)
    upper_white = np.array([145, 60, 255],np.uint8)

    lower_red = np.array([0, 100, 120], np.uint8)
    upper_red = np.array([5, 255, 255],np.uint8)


    lower_orange = np.array([9, 100, 120],np.uint8)
    upper_orange = np.array([12, 255, 255],np.uint8)

    #lower_white = np.array([100, 10, 100])
    #upper_white = np.array([130, 200, 255])
